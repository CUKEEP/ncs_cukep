...
clear
figlet -f lean DORK | lolcat
echo
echo $white "*╔═════════════❖•ೋ° °ೋ•❖═════════════╗*"
echo $yellow"           Author: -CUKEP-   "
echo $white "*╚═════════════❖•ೋ° °ೋ•❖═════════════╝*"
echo
echo $indigo "               LIST DORK"
echo $white"    ╭──────────────╯•╰──────────────╮"
echo $white "   |       $red{1}DORK SQLi            $white|"
echo $white "   |       $yellow{2}DORK SHELL           $white|"
echo $white "   |       $cyan{3}DORK BYPASS ADMIN    $white|"
echo $white "   |       $indigo{4}DORK WORDPRESS       $white|"
echo $white "   |       $red{5}DORK POC KCFINDER    $white|"
echo $white "   |       $yellow{6}DORK POC CBT         $white|"
echo $white "   |       $cyan{7}DORK WH2BOX          $white|"
echo $white "   |       $indigo{8}DORK COM FABRIK      $white|"
echo $white "   |       $red{9}WEB VULN WEBDAV      $white|"
echo $white "   ╰──────────────•◈•──────────────╯"
echo $white "╭PILIH NOMERNYA"
    read -p " ╰─➳"  nomor 
echo
if [ $nomor = 1 ]
then
toilet -f slant --gay "SQLi"
echo "shop_details.php?prodid=
...
view_author.php?id=
main.php?id=" | lolcat
echo "╭Press ENTER for Exit" | lolcat
read -p "╰─➳" Exit
fi
...
inurl >:& quot mnux =& quot akademik
" | lolcat
echo $cyan "╭Press ENTER for exit"
    read -p " ╰─➳" Exit
fi    
echo
echo
...
intext:Mr Bumblebee inurl:/admin/
intext:Mr Bumblebee ext:php
intext:Mr Bumblebee ext:php5" | lolcat
echo $cyan "╭Press ENTER for Exit"
read -p " ╰─➳" Exit
fi
echo
if [ $nomor = 4 ]
then
figlet -f banner "WORDPRESS" | lolcat
echo
echo "inurl: wp-content/plugins/front-end-upload /
...
inurl: eklentileri / dekan-fckeditor-ile-pwwangs-kodu-plugin-için-wordpress /
...
inurl :/ images / idoblog / yükleme
inurl :/ bileşenleri / com_dv / formaliteler
...
inurl :/ yönetici / bileşenleri / com_simpleswfupload
...
inurl :/ bileşenleri / com_maianmedia /
inurl :/ modules / mod_dionefileuploader /
inurl :/ bileşenleri / com_hwdvideoshare
...
/ Wp-content/themes/modularity/includes/timthumb.php Grafik Kağıdı basın Design by
/ Wp-content/themes/cadabrapress/scripts/timthumb.php / temalar / cadabrapress / scripts /
/ Wp-content/themes/Avenue/timthumb.php Caddesi. Tüm hakları saklıdır.
...
/ Wp-content/themes/widescreen/includes/timthumb.php gizlemek menüsü
/ Wp-content/themes/Nyke/timthumb.php Nyke
/ Wp-content/themes/suffusion/timthumb.php Sayontan Sinha tarafından Kizarma WordPress teması
/ Wp-content/themes/kingsize/timthumb.php Navigasyon gizlemek
/ Wp-content/themes/headlines_enhanced/thumb.php PLR Bloglar *** 65533; Site Haritası *** 65533; Gizlilik Politikası
...
/ Wp-content/plugins/igit-related-posts-with-thumb-images-after-posts / / plugins / igit ile ilgili-mesaj-ile-başparmak görüntüleri-sonra-Mesajlar /
...
/ Wp-content/plugins/autofashion / / wp-content/plugins/autofashion" | lolcat
echo $yellow "╭Press ENTER for Exit"
read -p " ╰─➳" Exit
fi

if [ $nomor = 5 ]
then
figlet -f banner "KCFINDER" | lolcat
echo
echo "inurl:/asset/kcfinder
...
intitle: index of inurl:/kcfinder" | lolcat
echo $red "╭Press ENTER For Exit"
read -p " ╰─➳" Exit
fi
echo
if [ $nomor = 6 ]
then
toilet -f smslant "CBT"
echo 
echo "inurl:/panel/pages/login.php
-inurl:/login.php inurl:/cbt
-inurl:/login.php intitle:ujian online
-inurl:/login.php intitle:cbt beesmart
-inurl:/cbt/login.php site:sch.id" | lolcat
echo $yellow "╭Press ENTER For Exit"
read -p " ╰─➳" Exit
fi
...
if [ $nomor = 8 ]
then
figlet -f banner "FABRIK" | lolcat
echo
echo "inurl:index.php?option=com_fabrik
inurl:index.php/component/fabrik/ site:.dkinurl:index.php?option=com_fabrik&view= 
site:inurl:importcsv.php site:inurl:viewTable?cid= site:com" | lolcat
echo
echo $cyan "╭Press ENTER For Exit"
read -p " ╰─➳" Exit
fi
...
if [ $nomor = 9 ]
then
figlet -f lean "WEB VULN" | lolcat
echo $yellow"==================================="
echo
echo "http://africaprop.co.za/
http://www.alfunctiondesigns.co.za/
http://athenaeum.co.za/
http://geotrac.co.za/
http://www.compu7.co.za/
http://enetics.co.za/l
http://ballastbrokers.co.za/
...
http://branch.prospec.co.th/
http://expertads.co.za/
http://annettemuller.co.za/
...
www.statsrecord.net 
labweb.fsba.edu.br 
g-gconcretesolutions.com 
www.highsnabfarm.co.uk 
www.hzgsfda.gov.cn 
www.cdrqb.com 
wlax.4wmt.com 
www.e-ctasia.com 
...
qx.xiangtan.gov.cn 
wsc.utilgraph.it 
shengenxi.shoe-brand.cn 
www.supoil.com 
catalogo.btgitalia.it 
...
webapps.bwpress.com 
www.hlgljy.com 
b2c.atipicihiphopcity.com 
www.js-szyy.com 
www.shyyfw.gov.cn 
www.hyperoutlet.cz 
autodoplnky.mastershop.cz 
www.swd8.com
http://www.elcsfj.gov.cn/ 
...
http://www.vintagefaucet.net/ 
http://www.maxtek-go-go.com/ 
http://alessandro.espen.it/ 
http://www.maxpal.com.tw/ 
http://www.melroseschools.com/ 
http://chinaxuri.com.cn/ 
http://www.kozi.com.tw/ 
http://www.fengyi668.com/ 
http://pla.hbu.cn/link.html 
http://www.wiltrom.com.tw/ 
http://www.dialect.tw/ 
http://www.koul.com.tw/ 
http://www.digguitar.com/ 
...
http://www.591pqk.com/ 
http://www.unicenvirtual.net/ 
http://400.beilanqiye.com/ 
http://gszc.beilanqiye.com/ 
http://sia.nfcsys.com/ 
http://www.wzghl.com/ 
http://www.taiwan-ewa-mold.com.tw/ 
http://www.wzghl.com/l 
http://www.taiwan-ewa-mold.com.tw/
" | lolcat
echo $yellow "╭Press ENTER For Exit"
read -p " ╰─➳" Exit
